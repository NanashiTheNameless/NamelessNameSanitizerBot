...
(function(){
  ...
  function randomTint() {
    if (Math.floor(Math.random() * 100) + 1 <= 50) {
      const tintType = Math.floor(Math.random() * 100) + 1;
      if (tintType <= 33) {
        // Warm (yellow/orange)
        const r = clamp((255 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        const g = clamp((210 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        const b = clamp((170 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        return [r, g, b];
      } else if (tintType <= 66) {
        // Cool (cyan/blue)
        const r = clamp((160 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        const g = clamp((190 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        const b = clamp((255 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        return [r, g, b];
      } else {
        // Reddish
        const r = clamp((245 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        const g = clamp((200 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        const b = clamp((210 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
        return [r, g, b];
      }
    }
    // Neutral white with variation
    const w = clamp((225 + (Math.floor(Math.random() * 100) + 1 - 50)) | 0, 0, 255);
    return [w, w, w];
  }
  ...
  function makeStar() {
    ...
    if (roll <= 70) {
      ...
      const haloChance = Math.floor(Math.random() * 100) + 1;
      if (haloChance <= 95) {
      ...
      const haloChance = Math.floor(Math.random() * 100) + 1;
      if (haloChance <= 65) { // 65% halo chance
      ...
      const haloChance = Math.floor(Math.random() * 100) + 1;
      if (haloChance <= 50) { // 50% halo chance
